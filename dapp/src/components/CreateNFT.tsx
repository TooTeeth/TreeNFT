  ...
  return (
    <>
      <Flex maxW={1024} mx="auto" bgColor="purple.100" flexDir="column" flexGrow={1} alignItems="center" gap={2}>
        ...
        <Button colorPalette="green" variant="outline" onClick={handleMintNFT} loading={isLoading} loadingText="로딩중">
          민팅
        </Button>
      </Flex>
      <SuccessDialog isOpen={isOpen} setIsOpen={setIsOpen} title="민팅" message="민팅에 성공했습니다." />
    </>
  );
}
